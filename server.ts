...
export type {
  TCGplayerClientOptions,
  AutocompleteOptions,
  LatestSalesOptions,
  PriceHistoryOptions,
  ProductListingsOptions,
  FacetedRecommendationsOptions,
  TagsOptions,
  BestsellersOptions,
  TrendingOptions,
  ArticlesOptions,
 ...
 */
export async function autocomplete(query: string, options: { productLine?: string; sessionId?: string } = {}): Promise<unknown[]> {
 ...
 */
export async function getProductDetails(productId: number | string, mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getLatestSales(productId: number | string, options: {
  mpfev?: string;
 ...
 */
export async function getPriceHistory(productId: number | string, options: { range?: string } = {}): Promise<unknown> {
 ...
 */
export async function getVolatility(skuId: number | string, mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getBuylistPrice(productId: number | string, mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getSkuMarketPrices(skuIds: number[], mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getProductLines(): Promise<unknown> {
 ...
 */
export async function getProductLineMappings(productLine = 'Pokemon', mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getCategoryFilters(categoryId = '3', mpfev = '5429'): Promise<unknown> {
 ...
 */
export async function getLatestSets(productLineIds = '1,2,3,71,68,63,79,62,85'): Promise<unknown> {
 ...
 */
export async function getProductListings(productId: number | string, options: {
  sellerStatus?: string;
  channelId?: number;
  languages?: string[];
  conditions?: string[];
 ...
 */
export async function getSetName(setId: number | string): Promise<unknown> {
 ...
 */
export async function getFacetedRecommendations(productIds: number[], options: { limit?: number } = {}): Promise<unknown> {
 ...
 */
export async function getKickbacks(): Promise<unknown> {
 ...
 */
export async function getTags(domains = 'marketplace', classifications = 'product line affinity'): Promise<unknown> {
 ...
 */
export async function getVerticals(): Promise<unknown> {
 ...
 */
export async function getBestsellers(options: { categoryId?: string; limit?: number } = {}): Promise<unknown> {
 ...
 */
export async function getTrending(options: { productLine?: string; limit?: number } = {}): Promise<unknown> {
 ...
 */
export async function getCatalogGroups(): Promise<unknown> {
 ...
 */
export async function getFreeShippingThreshold(): Promise<unknown> {
 ...
 */
export async function getCountryCodes(): Promise<unknown> {
 ...
 */
export async function getArticles(options: { vertical?: string; limit?: number } = {}): Promise<unknown> {
 ...
 */
export async function getTrendingArticles(options: { limit?: number } = {}): Promise<unknown> {
  const { limit = 10 } = options;
 ...
 */
export async function getInfiniteProduct(productId: number | string): Promise<unknown> {
 ...
 */
export async function normalizeCardName(name: string): Promise<unknown> {
 ...
 */
export async function searchProducts(query: string, options: SearchOptions = {}): Promise<unknown> {
 ...
 */
export async function getProduct(productId: number | string): Promise<{ details: unknown; sales: unknown; priceHistory: unknown }> {
